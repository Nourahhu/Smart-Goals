...
if (isset($_SESSION['user_photo_path'])) {
    ...
    // $_SESSION["user_photo_path"] = "new_photo_path.jpg";

}
if (isset($_SESSION['user_full_name'])) {
    $user_full_name = $_SESSION['user_full_name'];
    //    $_SESSION["user_full_name"] = "New User Full Name";
}
...
<a href="contact.html"><i class="fas fa-headset"></i><span>contact us</span></a>
    ...
    box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; " class="container">
        ...
        <div>
            <p>
            <h5 style="text-align:center;">Not registered yet <a style="  transition: opacity 0.5s;"
                    href="registration.php">Register</a></h5>
            </p>
        </div>
    </div>
